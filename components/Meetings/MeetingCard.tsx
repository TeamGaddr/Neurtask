...
// 	endDate?: string;
// 	startTime?: string; // "07:57" (24h) or "07:57"
// 	endTime?: string;
...
// 	}
// 	// If dateStr looks like dd/mm/yyyy
...
// 			// backend returns array of meetings — normalize shape
...
// 			})) as ApiMeeting[];
// 			// sort DESCENDING by start date/time (most recent first)
// 			normalized.sort((a, b) => {
// 				const aDate =
...
// 	useEffect(() => {
// 		fetchMeetings();
// 		// optional: refresh every 60s to keep "ongoing" accurate
// 		const id = setInterval(fetchMeetings, 60 * 1000);
// 		return () => clearInterval(id);
// 	}, []);

// 	// group meetings into Today / Yesterday / Upcoming
...
// 		// helper to sort a group DESC by start datetime (most recent first)
...
// 					}
// 				}}
// 				className='flex items-center justify-between py-4 border-b last:border-b-0 cursor-pointer hover:shadow-sm rounded-md focus:outline-none focus:ring-2 focus:ring-primary'>
